  ...
  return (
    <div>
      ...
      <div className="section group" style={{ maxWidth: '940px', margin: '0 auto' }}>
        ...
        <div className="col span_12_of_12" style={{ display: 'flex', justifyContent: 'space-between' }}>
          <ButtonLight size='big' text='Hello' bgColor='green' />
          <ButtonLight size='big' text='Hello' bgColor='green' roundSize='0.188rem' />
          <ButtonLight size='big' text='Hello' bgColor='green' roundSize='0.5rem' />
          <ButtonLight size='big' text='Hello' bgColor='green' roundSize='1.688rem' />
        </div>
        <div className="col span_12_of_12" style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <div className="col span_12_of_12" style={{ display: 'flex', justifyContent: 'space-between' }}>
          <ButtonLight text='Hello' bgColor='red' />
          <ButtonLight text='Hello' bgColor='red' roundSize='3px' />
          <ButtonLight text='Hello' bgColor='red' roundSize='6px' />
          <ButtonLight text='Hello' bgColor='red' roundSize='23px' />
        </div>
        <div className="col span_12_of_12" style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <div className="col span_12_of_12" style={{ display: 'flex', justifyContent: 'space-between' }}>
          <ButtonLight size='small' text='Hello' bgColor='blue' />
          <ButtonLight size='small' text='Hello' bgColor='blue' roundSize='3px' />
          <ButtonLight size='small' text='Hello' bgColor='blue' roundSize='5px' />
          <ButtonLight size='small' text='Hello' bgColor='blue' roundSize='20px' />
        </div>
      </div>
    </div>
  )
