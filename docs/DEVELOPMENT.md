...
1. Проверьте клиентский редирект в корневом `app/page.tsx`
2. Убедитесь, что файлы локализации существуют в `i18n/locales/`
3. Проверьте использование `getTranslations` в компонентах
