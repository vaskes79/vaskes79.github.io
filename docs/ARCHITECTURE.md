...
- Клиентский редирект на корневой странице для определения языка по умолчанию
- Файлы локализации в формате JSON: `i18n/locales/en.json`, `i18n/locales/ru.json`
...
1. Корневая страница (`app/page.tsx`) определяет язык браузера на клиенте
2. Выполняется клиентский редирект на соответствующий `[locale]` сегмент
